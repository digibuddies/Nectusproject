...
*/
    ...
    public void callme2() {
        if(datadb.size()>0) {
            ...
            d1.setText(datadb.get(0)+", you can call me "+userid.get(0)+". I am here since "+datadb2.get(0)+". Currently I am a student of "+datadb3.get(0)+" and I love to practice my "+datadb4.get(0)+" skills. I would like to "+datadb5.get(0)+" someday. My friends say I'm "+datadb6.get(0)+". I just "+datadb7.get(0)+" "+datadb8.get(0)+" I spend most of my day "+datadb9.get(0)+". A person with same mind as mine would be "+datadb10.get(0)+".");
            d2.setText(datadb.get(1)+", you can call me "+userid.get(1)+". I am here since "+datadb2.get(1)+". Currently I am a student of "+datadb3.get(1)+" and I love to practice my "+datadb4.get(1)+" skills. I would like to "+datadb5.get(1)+" someday. My friends say I'm "+datadb6.get(1)+". I just "+datadb7.get(1)+" "+datadb8.get(1)+" I spend most of my day "+datadb9.get(1)+". A person with same mind as mine would be "+datadb10.get(1)+".");
            d3.setText(datadb.get(2)+", you can call me "+userid.get(2)+". I am here since "+datadb2.get(2)+". Currently I am a student of "+datadb3.get(2)+" and I love to practice my "+datadb4.get(2)+" skills. I would like to "+datadb5.get(2)+" someday. My friends say I'm "+datadb6.get(2)+". I just "+datadb7.get(2)+" "+datadb8.get(2)+" I spend most of my day "+datadb9.get(2)+". A person with same mind as mine would be "+datadb10.get(2)+".");
