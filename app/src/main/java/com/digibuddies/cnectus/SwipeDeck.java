...
import com.digibuddies.cnectus.Utility.CardContainer;
import com.digibuddies.cnectus.Utility.Deck;
import com.digibuddies.cnectus.Utility.SwipeCallback;
...
public class SwipeDeck extends FrameLayout {
    ...
    private void addNextView() {
        if (adapterIndex < mAdapter.getCount()) {
            ...
            CardContainer card = new CardContainer(newBottomChild, this , (SwipeCallback) new CardContainerCallback(viewId));
